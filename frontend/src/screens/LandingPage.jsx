    ...
    <div className="landing-page">
        ...
        <Container>
          <Row className="justify-content-center">
            <Col md={10} lg={8}>
              ...
              <p className="lead">
                Polenia Ginger Beer – Crafted from agroecological ginger, packed
                with natural flavor.
              </p>
              <Button
                variant="success"
                size="lg"
                className="mt-3 hero-cta-btn"
                href="#about"
              >
                Know More →
              </Button>
      ...
      <section id="about" className="about py-5 bg-light text-center">
        <Container>
          ...
          <p className="lead">
            Handcrafted with organic ginger and bottled sustainably, Polenia is
            more than a beverage – it's a commitment to flavor, health, and the
            planet.
          </p>
        </Container>
      </section>
      ...
      <section className="logo-carousel py-5">
        ...
        <p className="text-center mb-4">
          We are proud to collaborate with local businesses and organizations.
        </p>
        <Swiper
