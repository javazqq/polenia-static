    ...
    <div className="landing-page">
          ...
          <Row className="justify-content-center">
            <Col md={10} lg={8}>
              ...
              <Button
                variant="success"
                size="lg"
                className="mt-3 hero-es-cta-btn"
                href="#about"
              >
                Conoce más →
              </Button>
          ...
          >
            ...
            <g className="parallax">
              ...
              <use
                ...
                x="48"
                y="3"
                fill="rgba(255, 138, 128, 0.5)"
              />
              <use
                href="#gentle-wave"
                x="48"
                y="5"
                fill="rgba(244, 143, 177, 0.5)"
              />
              <use
                href="#gentle-wave"
                x="48"
                y="7"
                fill="rgba(206, 147, 216, 0.4)"
              />
            </g>
          </svg>
        </div>
      ...
      <section className="cta-uno-section">
        <div className="cta-uno-content">
          ...
          <p className="lead">
            Suscríbete a nuestro boletín para recibir ofertas y novedades
            exclusivas.
          </p>
      ...
      <section id="about" className="about py-5 bg-light text-center">
        <Container>
          ...
          <p className="lead">
            Hecha artesanalmente con jengibre orgánico y embotellada de forma
            sostenible. Polenia es más que una bebida: es un compromiso con el
            sabor, la salud y el planeta.
          </p>
        </Container>
      </section>
          ...
          <Row className="gy-4">
            ...
            <Col md={6} lg={3}>
              <div className="feature-box">
                ...
                <h5>Ecológica</h5>
                <p>
                  Reutilizamos botellas de vidrio y evitamos residuos plásticos.
                </p>
              </div>
            </Col>
            <Col md={6} lg={3}>
      ...
      <section className="logo-carousel py-5">
        ...
        <p className="text-center mb-4">
          Estamos orgullosos de colaborar con negocios y organizaciones locales.
        </p>{" "}
        <Swiper
        ...
        >
          <SwiperSlide>
            <img
              ...
              src="/images/panconmadrelogo.png"
              alt="Logo 1"
            />
          </SwiperSlide>
          <SwiperSlide>
